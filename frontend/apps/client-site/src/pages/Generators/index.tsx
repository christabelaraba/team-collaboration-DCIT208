                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                    ...
                    <div className='w-full mt-6 lg:mt-0'>
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4'>
                            <input id='firstName' placeholder='First Name' className='w-full h-12 md:h-16 text-gray-700 bg-white shadow-md border-black rounded-lg px-5' />
                            <input id='lastName' placeholder='Last Name' className='w-full h-12 md:h-16 text-gray-700 bg-white shadow-md border-black rounded-lg px-5' />
                            <input id='email' type='email' placeholder='Email' className='w-full h-12 md:h-16 text-gray-700 bg-white shadow-md border-black rounded-lg px-5' />
                            <input id='phone' placeholder='Phone Number' className='w-full h-12 md:h-16 text-gray-700 bg-white shadow-md border-black rounded-lg px-5' />
                        </div>

                        <div className='w-full'>
                            <textarea id='message' placeholder='Message' className='w-full h-32 md:h-40 text-gray-700 bg-white shadow-md border-black rounded-lg px-5 mb-4' />
                            <button type="submit" className="w-full sm:w-32 text-lg md:text-xl h-12 bg-orange-600 text-white rounded hover:bg-orange-700 uppercase tracking-wider">Send</button>
                        </div>
                    </div>
                </div>
            </section>
